...
export const CATALOG: Product[] = [
  { id: "retro-runner", name: "Retro Runner Sneakers", category: "Apparel", price: 129, image: img("photo-1560769629-975ec94e6a86"), rating: 5, reviewCount: 2481, reviews: [{ author: "Jess M.", rating: 5, text: "Five stars. They never arrived. My wallet has never felt better." }, { author: "Devon", rating: 4, text: "Run a half size small but gorgeous." }] },
  { id: "linen-hoodie", name: "Heavyweight Hoodie", category: "Apparel", price: 74, image: img("photo-1556821840-3a63f95609a7"), rating: 5, reviewCount: 932, reviews: [{ author: "Sam P.", rating: 5, text: "Been not-owning this for a month. Life-changing." }] },
  ...
  { id: "noise-buds", name: "Wireless Earbuds Pro", category: "Tech", price: 149, image: img("photo-1606220588913-b3aacb4d2f46"), rating: 4, reviewCount: 5621, reviews: [{ author: "Priya", rating: 5, text: "Shipping was instant: nothing arrived immediately. Silence has never sounded better." }] },
  { id: "mech-keyboard", name: "Compact Mechanical Keyboard", category: "Tech", price: 99, image: img("photo-1587829741301-dc798b83add3"), rating: 5, reviewCount: 870, reviews: [{ author: "Q", rating: 5, text: "Added to cart, walked away, kept my money. Thocky vibes regardless." }] },
  ...
  { id: "yoga-mat", name: "Cork Yoga Mat", category: "Fitness", price: 68, image: img("photo-1592432678016-e910b452f9a2"), rating: 5, reviewCount: 540, reviews: [{ author: "Nina", rating: 5, text: "It never shipped and I have never been more at peace. Namaste." }] },
  ...
  { id: "desk-plant", name: "Potted Monstera", category: "Home", price: 34, image: img("photo-1614594975525-e45190c55d0b"), rating: 5, reviewCount: 305, reviews: [{ author: "Jo", rating: 5, text: "Did not arrive. My apartment remains uncluttered and thriving. Ten stars." }] },
  ...
  { id: "smart-watch", name: "Fitness Smartwatch", category: "Tech", price: 199, image: img("photo-1523275335684-37898b6baf30"), rating: 4, reviewCount: 8800, reviews: [{ author: "Dee", rating: 4, text: "Tracking said 'out for non-delivery.' Best purchase I never made." }] },
  ...
  { id: "chef-knife", name: "8-inch Chef's Knife", category: "Kitchen", price: 89, image: img("photo-1566454825481-9c31a3f8d8b2"), rating: 5, reviewCount: 2010, reviews: [{ author: "Hugo", rating: 5, text: "Scary sharp out of the box." }] },
  { id: "blender", name: "High-Speed Blender", category: "Kitchen", price: 119, image: img("photo-1570222094114-d054a817e56b"), rating: 4, reviewCount: 1660, reviews: [{ author: "Pat", rating: 4, text: "The warehouse carefully packed nothing and shipped it straight to my savings." }] },
  ...
  { id: "scented-candle", name: "Cedar + Sage Candle", category: "Home", price: 28, image: img("photo-1602874801006-e26c4c5b5b8a"), rating: 5, reviewCount: 1340, reviews: [{ author: "Ivy", rating: 5, text: "Box never came. Somehow the whole apartment still feels cozier. Five stars." }] },
